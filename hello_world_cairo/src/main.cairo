...
trait IHelloWorld<TContractState>{
    ...
    fn update_hello_world(ref self: TContractState, new_value: felt252);
}
...
mod contract{
    ...
    impl HelloWorld of super::IHelloWorld<ContractState>{
        ...
        fn update_hello_world(ref self: ContractState, new_value: felt252){
            self.hello_world.write(new_value);
        }
    }
}